...
//		System.out.println(es);
	...
	String astA = "{\"start\": {\"path\": [\r\n"
			...
			+ "   {\"step\": {\"compare\": {\r\n"
			+ "      \"op\": \"eq\",\r\n"
			+ "      \"arg\": {\"path\": [{\"step\": {\"constant\": 88}}]}\r\n"
			+ "   }}},\r\n"
			+ "   {\"step\": {\"compare\": {\r\n"
			+ "      \"op\": \"eq\",\r\n"
			+ "      \"arg\": {\"path\": [{\"step\": {\"constant\": -144000000000}}]}\r\n"
			+ "   }}},\r\n"
			+ "   {\"step\": {\"compare\": {\r\n"
			+ "      \"op\": \"eq\",\r\n"
			+ "      \"arg\": {\"path\": [{\"step\": {\"constant\": \"lolo\"}}]}\r\n"
			+ "   }}},\r\n"
			+ "   {\"step\": {\"compare\": {\r\n"
			+ "      \"op\": \"eq\",\r\n"
			+ "      \"arg\": {\"path\": [{\"step\": {\"var\": \"x\"}}]}\r\n"
			...
			+ "      {\"step\": {\"property\": \"b\"}}\r\n"
			+ "   ]}}},\r\n"
			+ "   {\"step\": {\"message\": {\"path\": [{\"step\": {\"constant\": \"lala\"}}]}}}\r\n"
			+ "]}}";
}
